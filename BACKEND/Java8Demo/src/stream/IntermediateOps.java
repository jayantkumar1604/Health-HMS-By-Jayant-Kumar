...
public class IntermediateOps {
    public static void main(String[] args) {
        ...
        // They are lazy, meaning they don't execute until a terminal operation invoked.
        ...
        //2.map
        Stream<String> stringStream= list.stream().map(z->z.toUpperCase());
        ...
        // Flatten nested structures(eg...,list with in list)so that they can be processed as a single sequence of elements
        // Transform and flatten elements at the same table
