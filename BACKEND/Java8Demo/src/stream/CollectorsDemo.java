...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        String concatenated= names.stream().map(String::toUpperCase).collect(Collectors.joining(", "));
        System.out.println(concatenated);

        // 5. Summerizing Data
        // Generates statistical summary(count,sum,average,max)
        ...
        System.out.println(fruits.stream().collect(Collectors.toMap(x-> x.toUpperCase(),x->x)));
